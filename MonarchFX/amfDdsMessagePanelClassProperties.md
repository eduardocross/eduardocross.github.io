---
title: DdsMessagePanel Properties

Id: amfDdsMessagePanelClassProperties
TocParent: amfDdsMessagePanelClass
TocOrder: 30

keywords: DdsMessagePanel class, properties
keywords: properties [ASNA.Monarch.WebDspF],DdsMessagePanel class

---

[ DdsMessagePanel Overview](amfDdsMessagePanelClass.html) 

This page includes members inherited from System.Web.UI.WebControls.WebControl and System.Web.UI.WebControls.Panel. See [DdsMessagePanel Class Members](amfDdsMessagePanelClassMembers.html) for a list that excludes inherited properties.
...
<table class="mytable" cellspacing="0" cellpadding="4" width="90%">
          ...
          <th>Description</th>
            ...
            <td style="height: 31px; width: 218px;">![](Images/property.bmp) [
              DefaultButton](http://msdn.microsoft.com/en-us/library/system.web.ui.webcontrols.webcontrol.bordercolor(v=vs.110).aspx">BorderColor</a></td>
          ...
          <tr>
            <td>![](Images/property.bmp)
              <a href="amfDdsMessagePanelClassDefaultButtonProperty.html)
            </td>
            ...
            <tr>
            <td>![](Images/property.bmp) 
            [GroupingText](http://www.w3schools.com/aspnet/prop_webcontrol_panel_direction.asp">Direction</a></td>
            ...
            ResetButtonText](http://msdn.microsoft.com/en-us/library/system.web.ui.webcontrols.webcontrol.height(v=vs.110).aspx">Height</a></td>
			...
			<tr>
            <td>![](Images/property.bmp)  
            <a href="amfDdsMessagePanelClassResetButtonTextProperty.html)</td>
            <td>Gets or sets the text to
            use to reset the default button.</td>
            </tr>
			<tr>
            <td>![](Images/property.bmp) [
              Visible](http://msdn.microsoft.com/en-us/library/system.web.ui.webcontrols.panel.scrollbars(v=vs.110).aspx">Scrollbars</a></td>
            <td>Sets whether this control will have scollbars. (Inherited from ASP.NET Panel.)</td>
            </tr>
			<tr>
            <td style="height: 31px; width: 218px;">![](Images/property.bmp) <a href="http://msdn.microsoft.com/en-us/library/system.web.ui.control.skinid(v=vs.110).aspx">SkinID</a></td>
			...
			<tr>
            <td style="height: 31px; width: 218px;">![](Images/property.bmp) [
      DdsMessagePanel Class](http://msdn.microsoft.com/en-us/library/system.web.ui.webcontrols.webcontrol.width(v=vs.110).aspx">Width</a></td>
...
#### See Also
<a href="amfDdsMessagePanelClass.html)
      <br clear="none" />
      [
